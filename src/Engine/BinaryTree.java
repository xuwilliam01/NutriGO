...
class BinaryTree<E extends Comparable<E>>
{
	...
	/**
	 * Converts the tree to a string recursively given the starting position
	 * @param position the starting position
	 * @return the String version of the tree
	 */
	public String toString(BinaryTreeNode<E> position)
	{
		String output = position.getItem().toString()+" ";
		if(position.getLeft() != null)
		{
			output += toString(position.getLeft())+ " ";
		}
		if(position.getRight() != null)
		{
			output += toString(position.getRight()) +" ";
		}	
		return output;
	}
}
